...
<div class="detail-wrap">
    ...
    <div class="detail-layout">
        ...
        <div>
            ...
            {{-- FASILITAS UMUM KOS --}}
            @php $fasUmum = $kos->fasilitas ?? collect(); @endphp
            @if($fasUmum && (is_array($fasUmum) ? count($fasUmum) : $fasUmum->count()) > 0)
            <div class="section-box">
                <div class="section-title">Fasilitas Umum Kos</div>
                <p class="section-sub">Fasilitas bersama yang tersedia di {{ $kos->nama_kost }}</p>
                <div class="fasilitas-grid">
                    @foreach($fasUmum as $f)
                    <div class="fasilitas-chip">
                        <svg viewBox="0 0 24 24">
                            <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z" />
                        </svg>
                        {{ is_string($f) ? $f : $f->nama_fasilitas }}
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="section-box">
                ...
                <div class="foto-grid">
                    ...
                    <img src="{{ $foto }}" alt="Foto {{ $i + 1 }}" onclick="bukaModal({{ $i }})">
                    @endforeach
                </div>
            </div>
            @endif
