...
<div class="max-w-8xl mx-auto flex flex-col gap-6 px-4 py-2">
    ...
    {{-- HERO --}}
    <div class="bg-white rounded-2xl border border-[#E2EAE3] px-6 lg:px-8 py-7 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center relative overflow-hidden">
        ...
        <div class="hidden lg:flex justify-end items-center relative z-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-2xl border border-[#E2EAE3] px-6 py-6">
            ...
            @php
            $faqs = [
                ['q' => 'Bagaimana cara mencari kos?', 'a' => 'Klik tombol "Jelajahi Sekarang" di beranda, lalu gunakan filter kota, harga, dan fasilitas untuk menemukan kos yang sesuai.'],
                ['q' => 'Apakah daftar gratis?', 'a' => 'Ya, mendaftar sebagai penghuni sepenuhnya gratis tanpa biaya apapun.'],
                ['q' => 'Cara daftarkan kos saya?', 'a' => 'Daftar sebagai Admin/Owner, masuk ke dashboard, dan klik "Tambah Kos". Isi detail kos lengkap beserta foto.'],
                ['q' => 'Bisa survey kos dulu?', 'a' => 'Tentu bisa. Hubungi pemilik kos langsung melalui kontak di halaman detail kos untuk mengatur jadwal survey.'],
                ['q' => 'Bagaimana jika kos tidak sesuai?', 'a' => 'Segera hubungi tim KosinAja melalui WhatsApp atau email. Kami akan menindaklanjuti dan membantu menyelesaikan masalah.'],
                ['q' => 'Apakah data saya aman?', 'a' => 'Ya, data pribadimu tidak akan dibagikan kepada pihak ketiga tanpa izin.'],
            ];
            @endphp
        ...
        <div class="bg-white rounded-2xl border border-[#E2EAE3] overflow-hidden flex flex-col">
            ...
            <div class="px-6 py-4 flex items-center gap-2.5">
                ...
                <span class="text-[0.78rem] text-[#4A5E4C] font-medium leading-snug">Banyuwangi, Jawa Timur<br>Indonesia</span>
            </div>
        </div>
    ...
    {{-- FORM KIRIM PESAN --}}
    <div class="bg-white rounded-2xl border border-[#E2EAE3] px-6 lg:px-8 py-7">
        <span
            class="inline-flex items-center gap-1 text-[0.65rem] font-bold tracking-widest uppercase text-[#5F8568] bg-[rgba(95,133,104,0.10)] border border-[rgba(95,133,104,0.22)] px-3 py-1 rounded-full mb-2">
            Pesan
        </span>
        ...
        <p class="text-[0.78rem] text-[#7A8A7C] mb-5">Isi form di bawah dan kami akan membalas melalui email secepat mungkin.</p>

        @if(session('success'))
        <div class="mb-4 px-4 py-3 bg-[#eef4ef] border border-[#5F8568] rounded-xl text-[0.78rem] font-semibold text-[#5F8568]">
            ✅ {{ session('success') }}
        </div>
        @endif
    ...
    {{-- BANTUAN WHATSAPP --}}
    <div class="bg-white rounded-2xl border border-[#E2EAE3] px-6 lg:px-8 py-7 flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-1">
        <div
        ...
        <div class="flex-1">
            ...
            <div class="flex gap-2.5 flex-wrap">
                ...
                <a href="mailto:twoorbital@gmail.com"
                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-transparent border-2 border-[#5F8568] text-[#5F8568] hover:bg-[#5F8568] hover:text-white rounded-xl font-bold text-[0.78rem] transition-colors no-underline">
                    <svg class="w-4 h-4 fill-[#5F8568]" viewBox="0 0 24 24">
                        <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                    </svg>
                    Kirim Email
                </a>
