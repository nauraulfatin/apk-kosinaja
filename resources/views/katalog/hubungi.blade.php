...
<div class="max-w-8xl mx-auto flex flex-col gap-6 px-4 py-2">
    ...
    {{-- HERO --}}
    <div
        class="bg-white rounded-2xl border border-[#E2EAE3] px-6 lg:px-8 py-7 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center relative overflow-hidden">
    ...
    {{-- BANTUAN WHATSAPP --}}
    <div
        class="bg-white rounded-2xl border border-[#E2EAE3] px-6 lg:px-8 py-7 flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-1">
        <div
