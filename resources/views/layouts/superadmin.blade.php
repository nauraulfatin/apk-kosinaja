        ...
        <aside class="w-64 bg-white border-r border-gray-100 fixed h-full flex flex-col justify-between">
            ...
            <div>
                ...
                <div class="flex items-center gap-3 px-6 py-6 border-b border-gray-100">
                    ...
                    <img src="{{ asset('logo.png') }}" alt="Logo" class="h-11 w-11 object-contain">
                ...
                <nav class="flex-1 px-4 py-6 flex flex-col">
                    ...
                    {{-- DASHBOARD --}}
                    <a href="{{ route('superadmin.dashboard') }}" class="{{ $menuClass }}
                    ...
                    {{-- PENGAJUAN --}}
                    <a href="{{ route('superadmin.pengajuan.index') }}" class="{{ $menuClass }}
                    ...
                    {{-- RIWAYAT --}}
                    <a href="{{ route('superadmin.riwayat.index') }}" class="{{ $menuClass }}
                    ...
                    {{-- FASILITAS --}}
                    <a href="{{ route('superadmin.fasilitas.index') }}" class="{{ $menuClass }}
