            ...
            <div>
                ...
                <nav class="px-4 py-4 space-y-1">
                    ...
                    <a href="{{ route('admin.pengajuan.index') }}"
                        class="{{ $menuClass }} {{ request()->routeIs('admin.pengajuan.*') ? $activeClass : $inactiveClass }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    {{-- PENGHUNI --}}
                    <a href="{{ route('admin.penghuni.aktif') }}"
                    ...
                    <a href="{{ route('admin.tagihan.index') }}"
                        class="{{ $menuClass }} {{ request()->routeIs('admin.tagihan.*') ? $activeClass : $inactiveClass }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.kost.index') }}"
                        class="{{ $menuClass }} {{ request()->routeIs('admin.kost.*') ? $activeClass : $inactiveClass }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
