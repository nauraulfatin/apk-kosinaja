...
<div class="mb-8">
    <h1 class="text-3xl font-bold text-[#0F0937]"> Detail Pengajuan</h1>
    <p class="text-gray-500 mt-2"> Approve penghuni dan tentukan kamar. </p>
</div>
    ...
    >
        ...
        <div class="flex flex-col items-center">
            ...
            >
                ...
                <img
                    src="https://ui-avatars.com/api/?name={{ $riwayatHunian->user->nama }}" class="w-full h-full object-cover"
                >
            </div>
            <h2
                class="text-2xl font-bold mt-5 text-center"
            >
                {{ $riwayatHunian->user->nama }}
            </h2>
            <p class="text-gray-400 mt-1"> {{ $riwayatHunian->user->username }} </p>
        </div>

        <div class="mt-8 space-y-5">
            <div>
                <p class="text-sm text-gray-400"> NIK </p>
                <h4 class="font-semibold"> {{ $riwayatHunian->user->nik }}</h4>
            </div>

            <div>
                <p class="text-sm text-gray-400"> No HP </p>
                <h4 class="font-semibold"> {{ $riwayatHunian->user->no_hp }} </h4>
            </div>
            ...
            <div>
                ...
                <span
                    class="inline-flex px-4 py-2 rounded-xl bg-yellow-100 text-yellow-700 text-sm font-semibold"
                >
                    Menunggu Approval
                </span>
            </div>
...
@endif
            <form
                method="POST" action="{{ route('admin.pengajuan.approve', $riwayatHunian) }}" class="space-y-6"
            >
