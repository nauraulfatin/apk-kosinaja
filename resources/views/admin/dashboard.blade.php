...
<div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
    <div class="flex items-center justify-between gap-4">
        ...
        {{-- BUTTON COPY --}}
        <button
            type="button" onclick="copyKodeUndangan()" class="bg-[#6C8B6B] hover:bg-[#5B765A] text-white px-4 py-2 rounded-xl text-sm font-semibold transition"
        >
            Copy
        </button>
...
>
    ...
    <button
        type="submit" class="p-2 rounded-xl bg-yellow-100 hover:bg-yellow-200 text-yellow-700 transition"
        title="Refresh Kode"
    >
