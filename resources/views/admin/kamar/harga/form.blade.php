...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
    ...
    <form method="POST" action="{{ $item->exists
            ...
            : route('admin.kamar.harga.store', $kamar) }}" class="space-y-6">
        ...
        <div>
            ...
            <input type="number" name="harga" value="{{ old('harga', $item->harga) }}" placeholder="Contoh: 750000"
        ...
        <div class="flex flex-wrap gap-3 pt-4">
            ...
            <a href="{{ route('admin.kamar.harga.index', $kamar) }}"
