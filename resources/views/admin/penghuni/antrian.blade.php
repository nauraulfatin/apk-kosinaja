...
<div class="flex items-center justify-between mb-8">
    ...
    <div>
        ...
        <h1 class="text-3xl font-bold text-[#0F0937]">
            ...
            Daftar Antrian Penghuni

        </h1>

        <p class="text-gray-500 mt-2">

            Penghuni yang sedang menunggu kamar tersedia.
                ...
                @forelse($items as $i)
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <a
                                href="{{ route('admin.penghuni.formAktifkan', ['riwayatHunian' => $i,'from' => 'antrian']) }}"
                ...
                @empty
                    ...
                    <tr>
                        ...
                        <td colspan="5"
                            ...
                            Tidak ada penghuni dalam antrian
