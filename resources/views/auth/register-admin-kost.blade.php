...
<div class="h-screen bg-[#F8F5F0] flex overflow-hidden">
    ...
    {{-- FORM --}}
    <div class="w-full lg:w-[58%] h-screen overflow-y-auto   flex items-start justify-center px-4 py-6 lg:px-8 pt-6 lg:pt-10">
        <div class="w-full max-w-md lg:max-w-3xl bg-white rounded-[24px] lg:rounded-[32px]  border border-gray-100 shadow-sm p-5 lg:p-10">
            ...
            <div class="mb-6 lg:mb-10">
                <h1 class="text-[28px] lg:text-4xl font-bold text-[#0F0937]"> Daftar Sebagai Admin Kost </h1>
            ...
            <form method="POST" action="{{ route('register.admin') }}" >
                ...
                <div class="mb-10">
                    <div class="flex items-center gap-3 mb-5">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#6C8B6B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" placeholder="Masukkan nama lengkap" value="{{ old('nama') }}"  class="w-full rounded-xl lg:rounded-2xl border border-gray-200 px-4 py-3.5 lg:px-5 lg:py-4 text-sm lg:text-basefocus:ring-2 focus:ring-[#6C8B6B]">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nik" placeholder="Masukkan NIK" value="{{ old('nik') }}" class="w-full rounded-xl lg:rounded-2xl border border-gray-200 px-4 py-3.5 lg:px-5 lg:py-4  focus:ring-2 focus:ring-[#6C8B6B]">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="username" placeholder="Masukkan username anda" value="{{ old('username') }}"
                                class="w-full rounded-xl lg:rounded-2xl border border-gray-200 px-4 py-3.5 lg:px-5 lg:py-4 focus:ring-2 focus:ring-[#6C8B6B]">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_hp" placeholder="08xxxxxxxxxx" value="{{ old('no_hp') }}" class="w-full rounded-xl lg:rounded-2xl border border-gray-200 px-4 py-3.5 lg:px-5 lg:py-4 focus:ring-2 focus:ring-[#6C8B6B]">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="password" type="password" name="password" placeholder="Masukkan password"
                                    class="w-full rounded-xl lg:rounded-2xl border border-gray-200 px-4 py-3.5 lg:px-5 lg:py-4 pr-14 focus:ring-2 focus:ring-[#6C8B6B]">

                                <button type="button" onclick="togglePassword('password')"
                                    class="absolute right-4 lg:right-5 top-1/2 -translate-y-1/2 text-gray-400">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <textarea name="alamat" rows="4" placeholder="Masukkan alamat lengkap kost"
                                class="w-full rounded-xl lg:rounded-2xl border border-gray-200 px-4 py-3.5 lg:px-5 lg:py-4  focus:ring-2 focus:ring-[#6C8B6B]">{{ old('alamat') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <button type="submit" class="w-full bg-[#6C8B6B]  hover:bg-[#5B765A] text-white font-semibold py-3.5 lg:py-5 rounded-xl lg:rounded-2xl text-base lg:text-lg transition">
                    Daftar Sekarang
                </button>
                ...
                <div class="text-center mt-5 lg:mt-6">
                    <p class="text-gray-500">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="text-[#6C8B6B] font-semibold hover:underline"> Masuk di sini </a>
...
<div id="successModal" class="fixed inset-0 z-50
    ...
    <div class="bg-white rounded-3xl
               ...
               w-full mx-4 p-5 lg:p-8 rounded-[24px] lg:rounded-3xl text-center
